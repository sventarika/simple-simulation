...
class TestBaNeunzig:
    ...
    def _evaluate(self, scenario_name: str, scenario_dir: str):
        ...
        evaluation = SingleSimulationEvaluator(
            scenario, scenario_description, test_result, complete_result_dir
        )
    ...
    def test_combined_report(self):
        ...
        multi_simulation_manager = MultiSimulationManager(
            scenario_list, result_dir=result_dir, n_workers=1
        )
        ...
        for job_result in test_result.values():
            ...
            evaluator = SingleSimulationEvaluator(
